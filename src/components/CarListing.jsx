              ...
              <div className="p-6 md:p-8 space-y-6">
                ...
                <div className="flex flex-row gap-3 pt-2 relative z-10">
                  <button
                    ...
                    className="flex-1 px-4 py-3 bg-[#1A1A1A] border border-white/20 text-white font-semibold text-sm rounded-xl hover:border-[#B844E8] hover:text-[#B844E8] transition-all duration-300"
                    style={{ fontFamily: "Inter, sans-serif" }}
                  >
                    Rent
                  </button>
        ...
        {!showAll && (
          <div ref={paginationRef} className="flex justify-center items-center mt-12 space-x-2">
            <button
              ...
              className={`w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-200 ${currentPage === 1
            ...
            {[...Array(totalPages)].map((_, index) => {
              ...
              return (
                <button
                  ...
                  className={`w-10 h-10 rounded-lg flex items-center justify-center font-semibold transition-all duration-200 ${currentPage === pageNumber
            ...
            <button
              ...
              className={`w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-200 ${currentPage === totalPages
                ? 'bg-white/10 text-white/50 cursor-not-allowed'
                : 'bg-[#1A1A1A] border border-white/20 text-white hover:bg-[#2B2B2B] hover:border-[#B844E8]'
                }`}
            >

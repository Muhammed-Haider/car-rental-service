                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-14 mb-16">
                    ...
                    <div className="space-y-6 lg:pr-4">
                        ...
                        <div className="space-y-3 pt-2">
                            <a href="tel:+971554079239" className="group flex items-center gap-3 text-slate-400 hover:text-[#0057FF] transition-all duration-300">
                                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/5 border border-white/10 group-hover:bg-[#0057FF]/10 group-hover:border-[#0057FF]/30 transition-all duration-300">
                            ...
                            <a href="mailto:info@speedzone.ae" className="group flex items-center gap-3 text-slate-400 hover:text-[#0057FF] transition-all duration-300">
                                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/5 border border-white/10 group-hover:bg-[#0057FF]/10 group-hover:border-[#0057FF]/30 transition-all duration-300">
                                    <svg className="h-5 w-5 text-[#0057FF]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    ...
                    <div className="space-y-6">
                        <div className="space-y-3">
                            ...
                            <div className="h-0.5 w-10 bg-gradient-to-r from-[#0057FF] to-transparent rounded-full" />
                        </div>
                        <ul className="space-y-3.5">
                            {['About SpeedZone', 'Our Premium Fleet', 'Luxury Services', 'Testimonials', 'Contact & Location'].map((item) => (
                                <li key={item}>
                                    <a
                                        href="#"
                                        className="group flex items-center gap-3 text-[15px] text-slate-400 hover:text-white transition-all duration-300"

        ...
        <div className="relative group">
          ...
          <input
            ...
            className={`
              ...
              text-xs sm:text-sm text-[#0A1A2F]
              placeholder:text-[#0A1A2F]/60 shadow-lg ring-1 ring-white/20 backdrop-blur-md
              transition-all duration-400 ease-out focus:outline-none
              ${isFocused 
                ? 'bg-white ring-2 ring-[#0057FF] shadow-2xl shadow-blue-500/25' 
                : 'bg-white/90 hover:bg-white hover:ring-white/30'
              }
            `}
          />
          ...
          <motion.button
            ...
            className={`
              ...
              ${isFocused 
                ? 'bg-[#0048d1] hover:bg-[#0037aa]' 
                : 'bg-[#0057FF] hover:bg-[#0048d1]'
              }
            `}
          ...
          <AnimatePresence>
            {searchQuery && (
              <motion.button
                ...
                className="absolute right-12 sm:right-16 top-1/2 -translate-y-1/2 text-[#0A1A2F]/60 hover:text-[#0A1A2F] transition-colors"
              >
        ...
        {showResults && searchResults.length > 0 && (
          ...
          >
            <div className="max-h-64 sm:max-h-96 overflow-y-auto">
              {/* Results Header */}
              <div className="px-4 py-3 border-b border-gray-100/50 bg-gradient-to-r from-gray-50 to-white">
                ...
                {searchResults.map((car, index) => (
                  ...
                  >
                    <Link
                      ...
                      className="block p-3 hover:bg-gradient-to-r hover:from-blue-50 hover:to-white 
                               rounded-xl transition-all duration-200 group"
                    >
                      <div className="flex items-center gap-2 sm:gap-4">
                        {/* Car Image */}
                        <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-xl overflow-hidden flex-shrink-0 ring-1 ring-gray-200 group-hover:ring-blue-200 transition-colors">
                          <img
                            src={car.image}
                            alt={car.name}
                        ...
                        <div className="text-right flex-shrink-0">
                          <p className="font-bold text-gray-900 text-xs sm:text-sm">
                            ...
                            <span className="text-xs text-gray-500 font-normal"> AED/day</span>
                          </p>
                        </div>
                      </div>
                    </Link>
              ...
              {/* View All Results */}
              <div className="border-t border-gray-100/50 p-3 bg-gradient-to-r from-gray-50 to-white">
                <Link
                  href="/#car-listings"
                  onClick={handleResultClick}
                  className="block w-full text-center py-2 text-blue-600 hover:text-blue-700 
          ...
          >
            <div className="text-center">
              ...
              <p className="text-gray-600 text-xs sm:text-sm font-medium">
                No luxury cars found matching "<span className="text-gray-900">{searchQuery}</span>"
              </p>
              <p className="text-gray-500 text-xs mt-1 px-2">Try searching for brands like Ferrari, Lamborghini, or Porsche</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
